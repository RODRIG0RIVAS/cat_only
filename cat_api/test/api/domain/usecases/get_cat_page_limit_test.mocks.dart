...
// in cat_api/test/api/domain/usecases/get_cat_page_limit_test.dart.
...
import 'package:cat_api/api/domain/exceptions/cat_raw/cat_raw_exception.dart'
    as _i5;
import 'package:cat_api/api/domain/repository/cat_repository.dart' as _i3;
...
class MockCatRepository extends _i1.Mock implements _i3.CatRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.CatRawException, List<_i6.CatRaw>>> getFromLimit(
          int? page, int? limit) =>
      (super.noSuchMethod(Invocation.method(#getFromLimit, [page, limit]),
          returnValue:
              _i4.Future<_i2.Either<_i5.CatRawException, List<_i6.CatRaw>>>.value(
                  _FakeEither_0<_i5.CatRawException, List<_i6.CatRaw>>(this,
                      Invocation.method(#getFromLimit, [page, limit])))) as _i4
